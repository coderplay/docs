...
* By default, this statement is incompatible with MySQL. Typically, multiple TiDB servers are placed behind a load balancer. This built-in incompatibility helps avoid connections being terminated from an incorrect TiDB server.
